...
const wifiTool = tool({
  ...
  description: 'IMMEDIATELY call this tool whenever a guest mentions WiFi, internet, network, password, or connectivity. Do NOT ask for room number. Do NOT refer to welcome packets. Just call this tool and provide the network name and password from the response.',
...
CRITICAL - FORMATTING INFORMATION RESPONSES:
...
- NEVER use markdown formatting: NO **, NO ##, NO ###, NO __
- Use simple text with proper punctuation and paragraphs
- Present information as if speaking directly to the guest
- Use line breaks to separate different items/events for readability

Example BAD response: "**Sunday Morning Yoga** - **Time:** 8:00 AM"
Example GOOD response: "Sunday Morning Yoga takes place at 8:00 AM"

Or better: "We have a lovely Sunday Morning Yoga class on November 17th at 8:00 AM on the Rooftop Garden. Start your Sunday with a peaceful outdoor yoga session. All levels are welcome, and you can bring your own mat or rent one at the front desk."
